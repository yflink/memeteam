export const POOL_INDEX_FOR_MEME = 2;
export const POOL_INDEX_FOR_CHAIN = 0;

export const NOW_TIMESTAMP_UPDATED = 'NOW_TIMESTAMP_UPDATED'
...
export const STAKE_CONFIRMED = 'STAKE_CONFIRMED'
